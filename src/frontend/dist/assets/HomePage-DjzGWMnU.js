...
function MoneyLeftRing({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-40 h-40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Spending progress ring" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center gap-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-medium uppercase tracking-wider", children: "Left" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-display font-bold text-foreground leading-none", children: formatCurrency(moneyLeft) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: `text-[10px] font-semibold mt-0.5 ${status === "on-track" ? "text-success" : status === "caution" ? "text-warning" : "text-destructive"}`,
...
function CategoryPieChart({ expenses }) {
  const chartData = reactExports.useMemo(() => {
    ...
    return Object.entries(totals).sort(([, a], [, b]) => b - a).map(([cat, val]) => ({
      category: cat,
      value: val,
  ...
  if (chartData.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-6 text-muted-foreground gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl", children: "🌱" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-center", children: "Start logging expenses to see your spending breakdown" })
    ] });
  }
  const total = chartData.reduce((s, d) => s + d.value, 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: 120, height: 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Pie,
        {
          data: chartData,
          ...
          children: chartData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, entry.category))
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Tooltip,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-2 min-w-0", children: chartData.slice(0, 4).map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground truncate", children: entry.label })
          ] }),
...
function RecentExpenses({ expenses }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: recent.map((exp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate leading-tight", children: exp.note || getCategoryLabel(exp.category) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: getCategoryLabel(exp.category) })
          ] })
        ] }),
...
function HomePage() {
  ...
  const status = hasBudget ? getSpendingStatus(totalSpent, totalBudget) : "on-track";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", "data-ocid": "home-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 z-10 bg-card border-b border-border px-4 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground font-medium uppercase tracking-widest", children: [
          now.toLocaleString("en-IN", { month: "long" }),
          " ",
          now.getFullYear()
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-display font-bold text-foreground leading-tight", children: "FinTrack" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            status === "on-track" ? "On Track" : status === "caution" ? "Caution" : "Over Budget"
          ]
        }
      )
    ] }),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: hasBudget ? `linear-gradient(to right, ${status === "on-track" ? "oklch(0.58 0.18 148)" : status === "caution" ? "oklch(0.70 0.16 82)" : "oklch(0.54 0.22 22)"} ${hasBudget ? Math.min(totalSpent / totalBudget * 100, 100) : 0}%, oklch(var(--muted)) 0%)` : "oklch(var(--muted))"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground mb-4", children: "Money Left This Month" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
                    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-40 h-40 rounded-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                      MoneyLeftRing,
                      {
                        spent: totalSpent,
                        budget: totalBudget,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/60 rounded-xl p-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-0.5", children: "Spent" }),
                        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-20" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-display font-bold text-foreground", children: formatCurrency(totalSpent) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/60 rounded-xl p-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-0.5", children: "Budget" }),
                        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-20" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-display font-bold text-foreground", children: hasBudget ? formatCurrency(totalBudget) : "—" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/60 rounded-xl p-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-0.5", children: "Days Left" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-display font-bold text-foreground", children: daysLeft })
                      ] })
                    ] }) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: `mt-4 flex items-start gap-2 p-3 rounded-xl text-sm ${status === "on-track" ? "bg-success/10" : status === "caution" ? "bg-warning/10" : "bg-destructive/10"}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base leading-none mt-0.5", children: status === "on-track" ? "✨" : status === "caution" ? "🙏" : "💪" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              className: `font-semibold text-sm ${status === "on-track" ? "text-success" : status === "caution" ? "text-warning" : "text-destructive"}`,
                              children: msg.text
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: msg.sub })
                        ] })
                      ]
                    }
                  )
            ...
            Card,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "Spending Breakdown" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "text-xs rounded-full", children: [
                    expenses.length,
                    " items"
                  ] })
                ] }),
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-32 w-full rounded-xl" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryPieChart, { expenses })
              ] })
            }
          )
        }
      ),
      !isLoading && budget && Object.values(budget.categoryLimits).some(Boolean) && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 12 },
          animate: { opacity: 1, y: 0 },
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Card,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "Category Budgets" }),
                Object.values(Category).filter((cat) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          width: `${pct}%`,
                          background: catStatus === "on-track" ? "oklch(0.58 0.18 148)" : catStatus === "caution" ? "oklch(0.70 0.16 82)" : "oklch(0.54 0.22 22)"
                        }
                      }
                    ) })
                  ] }, cat);
            ...
            Card,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "Recent Expenses" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Link,
                    {
                      to: "/reports",
                ...
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mt-2", children: ["r1", "r2", "r3"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 rounded-xl" }, k)) }) : expenses.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", "data-ocid": "empty-state", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "🌱" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground mb-1", children: "No expenses logged yet" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                    "Tap the",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-primary font-bold", children: "+" }),
                    " button below to add your first expense!"
                  ] })
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(RecentExpenses, { expenses })
              ] })
            }
          )
        }
      ),
      !isLoading && !hasBudget && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          transition: { delay: 0.25 },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/profile", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-dashed border-primary/30 p-4 flex items-center gap-3 bg-primary/5 transition-smooth hover:border-primary/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "💰" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Set a monthly budget" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Track your spending against a goal →" })
            ] })
          ] }) })
        }
      ),
