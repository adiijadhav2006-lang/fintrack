import { b as clsx, R as React, r as reactExports, u as useExpensesByMonth, d as useBudget, j as jsxRuntimeExports, S as Skeleton } from "./index-Cx3uc6F2.js";
import { B as Button } from "./button-BbigOgdv.js";
import { C as Card, a as CardContent, f as formatCurrency, g as getCategoryIcon, b as getCategoryLabel, d as getCategoryColor, h as formatShortDate, c as getSpendingStatus } from "./formatters-Cun4OcDU.js";
import { m as motion } from "./proxy-DQTY6X4E.js";
import { B as getAngledRectangleWidth, n as isNumber, G as Global, E as getStringSize, q as mathSign, i as isFunction, T as Text, F as shallowEqual, f as filterProps, k as get, L as Layer, d as adaptEventsOfChild, e as Label, H as useChartWidth, I as useChartHeight, J as useOffset, K as useArbitraryXAxis, M as useYAxisWithFiniteDomainOrRandom, w as warn, N as getCoordinatesOfGrid, O as getTicksOfAxis, P as useXAxisOrThrow, Q as useYAxisOrThrow, x as generateCategoricalChart, U as Bar, V as formatAxisMap, R as ResponsiveContainer, z as Tooltip, s as Cell } from "./generateCategoricalChart-CEUlxp2u.js";
  ...
  return _createClass$2(CartesianAxis2, [{
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React.isValidElement(option)) {
        tickItem = /* @__PURE__ */ React.cloneElement(option, _objectSpread$1(_objectSpread$1({}, props), {}, {
...
function renderLineItem(option, props) {
  ...
  if (/* @__PURE__ */ React.isValidElement(option)) {
    ...
    lineItem = /* @__PURE__ */ React.createElement("line", _extends$2({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function CartesianGrid(props) {
  ...
  }), /* @__PURE__ */ React.createElement(HorizontalGridLines, _extends$2({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ React.createElement(VerticalGridLines, _extends$2({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ React.createElement(HorizontalStripes, _extends$2({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ React.createElement(VerticalStripes, _extends$2({}, propsIncludingDefaults, {
    verticalPoints
  })));
}
...
function DailyChart({ expenses }) {
  const data = reactExports.useMemo(() => {
    ...
    return Object.entries(byDay).map(([date, total]) => ({ date, total })).sort((a, b) => a.date.localeCompare(b.date)).slice(-14);
  }, [expenses]);
  if (data.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-28 text-muted-foreground text-sm", children: "No data yet" });
  }
  const maxVal = Math.max(...data.map((d) => d.total));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 150, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data, margin: { top: 4, right: 4, left: -24, bottom: 0 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "total", radius: [4, 4, 0, 0], maxBarSize: 24, children: data.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Cell,
      {
        fill: entry.total === maxVal ? "oklch(var(--primary))" : "oklch(var(--accent))"
      },
      entry.date
    )) })
  ] }) });
...
function CategoryBreakdown({
  ...
  const categories = reactExports.useMemo(() => {
    ...
    return Object.entries(totals).sort(([, a], [, b]) => b - a).map(([cat, amount]) => ({
      category: cat,
      amount,
  ...
  if (categories.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-6", children: "No spending data yet" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: categories.map(({ category, amount, pct }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: getCategoryLabel(category) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                pct,
                "%"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: formatCurrency(amount) })
            ] })
          ] }),
...
function csvExport(expenses, month, year) {
  const headers = "Date,Category,Amount (INR),Note\n";
  const rows = [...expenses].sort((a2, b) => Number(b.date - a2.date)).map((e) => {
    const ms = Number(e.date / 1000000n);
...
function ReportsPage() {
  ...
  const totalBudget = (budget == null ? void 0 : budget.totalAmount) ?? 0;
  const status = totalBudget > 0 ? getSpendingStatus(totalSpent, totalBudget) : "on-track";
  const savingsRate = totalBudget > 0 ? Math.max(
    0,
    Math.round((totalBudget - totalSpent) / totalBudget * 100)
  ) : 0;
  const filteredExpenses = reactExports.useMemo(
    () => filterCategory === "all" ? [...expenses].sort((a, b) => Number(b.date - a.date)) : [...expenses].filter((e) => e.category === filterCategory).sort((a, b) => Number(b.date - a.date)),
    [expenses, filterCategory]
  );
  const usedCategories = reactExports.useMemo(
    () => Array.from(new Set(expenses.map((e) => e.category))),
    [expenses]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", "data-ocid": "reports-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 z-10 bg-card border-b border-border px-4 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-display font-bold text-foreground", children: "Reports" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Monthly spending overview" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: MONTHS.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setMonth(i + 1),
              className: `shrink-0 px-3.5 py-1.5 rounded-full text-sm font-medium transition-smooth border ${month === i + 1 ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card border-border text-muted-foreground hover:border-primary/50 hover:text-primary"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-0 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-2", children: "Total Spent" }),
              isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-24" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-foreground", children: formatCurrency(totalSpent) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: status === "on-track" ? "badge-success" : status === "caution" ? "badge-warning" : "badge-alert",
                  style: { fontSize: "0.65rem", padding: "2px 8px" },
                  children: status === "on-track" ? "Under Budget" : status === "caution" ? "Near Limit" : "Over Budget"
                }
              ) })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-0 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider font-medium mb-2", children: "Savings Rate" }),
              isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-16" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-foreground", children: totalBudget > 0 ? `${savingsRate}%` : "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2", children: totalBudget > 0 ? `${formatCurrency(Math.max(0, totalBudget - totalSpent))} saved` : "Set a budget first" })
            ] }) })
          ]
        }
      ),
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Card,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground mb-4", children: "Daily Spending — Last 14 Days" }),
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-36 w-full rounded-xl" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(DailyChart, { expenses })
              ] })
            }
          )
        }
            ...
            Card,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "By Category" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                    MONTHS[month - 1],
                    " ",
                    year
                ...
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["s1", "s2", "s3"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 rounded-xl" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryBreakdown, { expenses, total: totalSpent })
              ] })
            }
          )
        }
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Card,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                ...
                usedCategories.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 overflow-x-auto pb-2 mb-3 -mx-1 px-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => setFilterCategory("all"),
                      className: `shrink-0 px-3 py-1 rounded-full text-xs font-medium border transition-smooth ${filterCategory === "all" ? "bg-primary text-primary-foreground border-primary" : "bg-muted border-border text-muted-foreground hover:border-primary/50"}`,
                      "data-ocid": "filter-all",
                      children: "All"
                    }
                  ),
                  usedCategories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      onClick: () => setFilterCategory(cat),
                      className: `shrink-0 flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium border transition-smooth ${filterCategory === cat ? "bg-primary text-primary-foreground border-primary" : "bg-muted border-border text-muted-foreground hover:border-primary/50"}`,
                      "data-ocid": `filter-${cat.toLowerCase()}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: getCategoryIcon(cat) }),
                ...
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["t1", "t2", "t3", "t4"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-xl" }, k)) }) : filteredExpenses.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: filteredExpenses.map((exp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: getCategoryIcon(exp.category)
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: exp.note || getCategoryLabel(exp.category) }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground shrink-0 ml-2", children: formatCurrency(exp.amount) })
                    ]
                  },
                  exp.id
                )) })
      ...
      !isLoading && expenses.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          transition: { delay: 0.3 },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-0 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 grid grid-cols-3 gap-2 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "Avg/Day" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-bold text-foreground mt-0.5", children: formatCurrency(
                Math.round(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "Transactions" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-bold text-foreground mt-0.5", children: expenses.length })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider", children: "Largest" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-bold text-foreground mt-0.5", children: formatCurrency(Math.max(...expenses.map((e) => e.amount))) })
            ] })
          ] }) })
        }
      ),
      !isLoading && !budget && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-dashed border-primary/30 p-4 bg-primary/5 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "💡 Set a budget to see savings rate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Go to Profile → Monthly Budget" })
      ] })
    ] })
  ] });
}
